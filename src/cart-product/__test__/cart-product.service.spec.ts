...
describe('CartProductService', () => {
  ...
  it('should return Delete Result adter delete product', async () => {
  ...
  it('should return error in excepetion delete', async () => {
  ...
  it('should return error in excepetion verify product in cart', async () => {
